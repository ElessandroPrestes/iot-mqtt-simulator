...
| **Node.js 22 LTS** | Versão usada pelo CI e pelas imagens; atende o requisito mínimo do toolchain aprovado |
...
- Dependências de build/teste que possuem peer dependencies entre si devem ser
  agrupadas pelo Dependabot conforme o ADR-007.
...
| Matrix de versões Node.js | Projeto usa Node 22 LTS como padrão; testar múltiplas versões não acrescenta valor no momento |
